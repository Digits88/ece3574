...
// in simulator we redefine to format for GeospatialNotes Developer console
...
{\
	NSString * exceptionName = [@"org.geospatialnotes." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.geospatialnotes";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIGeospatialNotesNativeItemNone = -1, 
	UIGeospatialNotesNativeItemSpinner = -2,
	UIGeospatialNotesNativeItemProgressBar = -3,
	
	UIGeospatialNotesNativeItemSlider = -4,
	UIGeospatialNotesNativeItemSwitch = -5,
	UIGeospatialNotesNativeItemMultiButton = -6,
	UIGeospatialNotesNativeItemSegmented = -7,
	
	UIGeospatialNotesNativeItemTextView = -8,
	UIGeospatialNotesNativeItemTextField = -9,
	UIGeospatialNotesNativeItemSearchBar = -10,
	
	UIGeospatialNotesNativeItemPicker = -11,
	UIGeospatialNotesNativeItemDatePicker = -12,
	
	UIGeospatialNotesNativeItemInfoLight = -13,
	UIGeospatialNotesNativeItemInfoDark = -14,
	
	UIGeospatialNotesNativeItemDisclosure = -15,
	
	UIGeospatialNotesNativeItemContactAdd = -16
};
