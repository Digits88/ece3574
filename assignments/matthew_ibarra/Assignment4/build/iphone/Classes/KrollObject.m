 ...
 * Copyright (c) 2009-2011 by GeospatialNotes, Inc. All Rights Reserved.
...
//@interface GeospatialNotesObject : NSObject
//@end

@interface GeospatialNotesObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[GeospatialNotesObject class]])
		{
			for (NSString *key in [[(GeospatialNotesObject*)o modules] allKeys])
			{
