...
@interface GeospatialNotesObject : KrollCoverageObject {
#else
@interface GeospatialNotesObject : KrollObject {
#endif
@private
...
extern NSString * GeospatialNotes$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	GeospatialNotesObject *_geospatialnotes;
	BOOL shutdown;
